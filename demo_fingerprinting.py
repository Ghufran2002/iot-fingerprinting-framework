...
=============================================================
  ...
  Live API: https://mdghufran-iot-fingerprinting.hf.space
=============================================================
"""
import urllib.request, json, time

BASE = "https://mdghufran-iot-fingerprinting.hf.space"
...
# Device 6: Smart Plug
plug = {
    "flow_duration": 1.5, "mean_iat": 0.2, "std_iat": 0.08,
    "min_iat": 0.03, "max_iat": 1.5, "packet_count": 6,
    "byte_count": 300, "packet_rate": 4, "byte_rate": 200,
    "mean_pkt_size": 50, "std_pkt_size": 12, "min_pkt_size": 25,
    "max_pkt_size": 120, "tcp_ratio": 0.25, "udp_ratio": 0.75,
    "syn_ratio": 0.08, "fin_ratio": 0.07, "rst_ratio": 0.02,
    "ack_ratio": 0.12, "is_https": 0.0, "is_mqtt": 1.0,
    "is_coap": 0.0, "is_mdns": 0.05, "is_ntp": 0.04,
    "dns_query_count": 1, "well_known_port_ratio": 0.55,
    "is_encrypted": 0.0, "upload_bytes": 150,
    "download_bytes": 150, "upload_download_ratio": 1.0,
    "unique_dest_ports": 2, "unique_dest_ips": 1,
    "port_entropy": 0.3, "ip_entropy": 0.2,
    "well_known_ports_count": 2, "mean_dest_port": 8883, "std_dest_port": 8
}
r = post("/fingerprint", plug)
result_line("192.168.1.55", "MQTT, 6 packets, power reporting bursts", r["device_type"], r["confidence"], r["is_known"])
print("  Key signals: MQTT port 8883, short burst flows, minimal packet count")
time.sleep(0.4)

# Device 7: Smart Speaker
speaker = {
    "flow_duration": 15.0, "mean_iat": 0.02, "std_iat": 0.015,
    "min_iat": 0.005, "max_iat": 0.8, "packet_count": 1500,
    "byte_count": 800000, "packet_rate": 100, "byte_rate": 55000,
    "mean_pkt_size": 550, "std_pkt_size": 150, "min_pkt_size": 64,
    "max_pkt_size": 1460, "tcp_ratio": 0.55, "udp_ratio": 0.45,
    "syn_ratio": 0.012, "fin_ratio": 0.010, "rst_ratio": 0.003,
    "ack_ratio": 0.38, "is_https": 1.0, "is_mqtt": 0.0,
    "is_coap": 0.0, "is_mdns": 0.12, "is_ntp": 0.05,
    "dns_query_count": 8, "well_known_port_ratio": 0.88,
    "is_encrypted": 1.0, "upload_bytes": 120000,
    "download_bytes": 680000, "upload_download_ratio": 0.18,
    "unique_dest_ports": 6, "unique_dest_ips": 5,
    "port_entropy": 1.8, "ip_entropy": 1.6,
    "well_known_ports_count": 5, "mean_dest_port": 443, "std_dest_port": 80
}
r = post("/fingerprint", speaker)
result_line("192.168.1.33", "HTTPS, voice streaming, 5 cloud IPs", r["device_type"], r["confidence"], r["is_known"])
print("  Key signals: Medium bandwidth, voice upload, HTTPS to cloud APIs")
time.sleep(0.4)

# Device 8: Smart Doorbell
doorbell = {
    "flow_duration": 30.0, "mean_iat": 0.008, "std_iat": 0.02,
    "min_iat": 0.002, "max_iat": 0.5, "packet_count": 5000,
    "byte_count": 4000000, "packet_rate": 180, "byte_rate": 140000,
    "mean_pkt_size": 850, "std_pkt_size": 350, "min_pkt_size": 64,
    "max_pkt_size": 1500, "tcp_ratio": 0.75, "udp_ratio": 0.25,
    "syn_ratio": 0.008, "fin_ratio": 0.007, "rst_ratio": 0.003,
    "ack_ratio": 0.50, "is_https": 1.0, "is_mqtt": 0.0,
    "is_coap": 0.0, "is_mdns": 0.08, "is_ntp": 0.04,
    "dns_query_count": 5, "well_known_port_ratio": 0.85,
    "is_encrypted": 1.0, "upload_bytes": 2500000,
    "download_bytes": 1500000, "upload_download_ratio": 1.67,
    "unique_dest_ports": 5, "unique_dest_ips": 3,
    "port_entropy": 1.5, "ip_entropy": 1.1,
    "well_known_ports_count": 4, "mean_dest_port": 443, "std_dest_port": 60
}
r = post("/fingerprint", doorbell)
result_line("192.168.1.88", "Camera+audio, motion-triggered, 2.5MB upload", r["device_type"], r["confidence"], r["is_known"])
print("  Key signals: Motion-triggered burst, high upload (video+audio), HTTPS")

print()
sep()
print("  CONCLUSION")
sep("-")
print("  All 8 IoT devices correctly identified using ONLY network traffic features.")
